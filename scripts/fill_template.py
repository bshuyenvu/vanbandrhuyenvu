...
Why this script exists:
    `mcp__word__search_and_replace` (python-docx based) often fails on text
    inside table cells when the .docx came from a .doc convert — text is
    split into multiple runs and python-docx's text search misses it.
    This script bypasses the issue by editing runs directly.
